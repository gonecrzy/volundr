...
`docs/CADQUERY_BACKEND.md` supersedes this ruleset for the CadQuery-primary transition. New product generation uses CadQuery prompt modes and provider-neutral ruleset naming.
