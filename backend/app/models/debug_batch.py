...
class DebugBatch(Base):
    ...
    frontend_build_identity: Mapped[str] = mapped_column(String(512), nullable=False)
    backend_build_identity: Mapped[str] = mapped_column(String(512), nullable=False)
    worker_build_identity: Mapped[str] = mapped_column(String(512), nullable=False)
